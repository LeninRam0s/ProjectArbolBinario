...
{
    class Adivina : ConexionMongoDB
    {
        private static Nodo raiz;

        public Adivina()
        {
            string predet = "Dragon";
            raiz = new Nodo(predet);
            //insertarDatos(predet,"default");
        ...
        private void animalNuevo(Nodo nodo)
        {
            ...
            Console.WriteLine($"Que pregunta con respuesta si / no, puedo hacerte para poder decir que es un: {nuevoA}");
            ...
            insertarDatos(nuevoA, pregunta);///////////////guardar db////////////////////
